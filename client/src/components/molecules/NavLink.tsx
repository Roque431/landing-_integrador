...
const StyledNavLink = styled.a<{ $active?: boolean }>`
  ...
  &::before {
    ...
    background: ${props => props.$active 
      ? `linear-gradient(90deg, ${theme.colors.primary.main}, ${theme.colors.secondary.main}, ${theme.colors.accent.main})`
      : 'transparent'
    };
  ...
  &:hover {
    ...
    transform: translateY(-2px);
      ...
      &::before {
      transform: scaleX(1);
      background: linear-gradient(90deg, ${theme.colors.primary.main}, ${theme.colors.secondary.main}, ${theme.colors.accent.main});
      background-size: 200% 100%;
