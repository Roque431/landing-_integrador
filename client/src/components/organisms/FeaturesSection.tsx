...
import { FaBrain, FaLightbulb, FaCircleCheck, FaGlobe, FaClock, FaClipboardList, FaUserTie, FaHandshake, FaTruck } from 'react-icons/fa6';
...
const features: Feature[] = [
  ...
  },
  {
    ...
    title: 'Conecta con Abogados',
    description: 'Cuando necesites asesoría especializada, te conectamos con abogados verificados. Revisa perfiles, calificaciones y elige el mejor match.',
  },
  {
    icon: <FaHandshake size={32} />,
    title: 'Matching Inteligente',
    description: 'Nuestra IA analiza tu caso y te sugiere los profesionales más adecuados según tu situación específica.',
  },
  {
    icon: <FaTruck size={32} />,
    title: 'Servicios al Instante',
    description: '¿Necesitas una grúa, taller mecánico o refaccionaria? Te mostramos opciones cercanas con contacto directo.',
  },
  {
