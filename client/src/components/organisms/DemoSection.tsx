...
const EnergyWave = styled.div`
  ...
  height: 100%;
  border-radius: 50%;
  border: 2px solid rgba(11, 37, 69, 0.6);
  top: 0;
  left: 0;
  ...
  @keyframes expandWave {
    0% {
      transform: scale(0.5);
      opacity: 1;
      border-color: ${theme.colors.accent.main}cc;
    }
    100% {
      transform: scale(1.5);
      opacity: 0;
      border-color: ${theme.colors.accent.main}00;
    }
  }
`;
...
const ExampleBadge = styled.button`
  background-color: rgba(107,15,26,0.12);
  ...
  &:hover {
  background-color: rgba(107,15,26,0.18);
